...
int main(int argc,char *argv[]) {
	...
	/* Create the palette to set on main window */
	QPalette palette;
	...
	palette.setColor(QPalette::Active, QPalette::Window, QColor(225, 225, 225));
	...
	palette.setColor(QPalette::Active, QPalette::AlternateBase, QColor(240, 240, 240));
	palette.setColor(QPalette::Active, QPalette::Background, QColor(225, 225, 225));
//	palette.setColor(QPalette::Active, QPalette::Foreground, QColor(255, 255, 255));
	...
	palette.setColor(QPalette::Active, QPalette::Button, QColor(225, 225, 225));
	...
	palette.setColor(QPalette::Active, QPalette::Highlight, QColor(0, 0, 128));
	palette.setColor(QPalette::Active, QPalette::HighlightedText, QColor(255, 255, 255));
	
	palette.setColor(QPalette::Inactive, QPalette::Window, QColor(225, 225, 225));
	...
	palette.setColor(QPalette::Inactive, QPalette::AlternateBase, QColor(240, 240, 240));
	palette.setColor(QPalette::Inactive, QPalette::Background, QColor(225, 225, 225));
//	palette.setColor(QPalette::Inactive, QPalette::Foreground, QColor(255, 255, 255));
	...
	palette.setColor(QPalette::Inactive, QPalette::Button, QColor(225, 225, 225));
	...
	palette.setColor(QPalette::Inactive, QPalette::Highlight, QColor(0, 0, 128));
	palette.setColor(QPalette::Inactive, QPalette::HighlightedText, QColor(255, 255, 255));
	
	palette.setColor(QPalette::Disabled, QPalette::Window, QColor(225, 225, 225));
	palette.setColor(QPalette::Disabled, QPalette::WindowText, QColor(128, 128, 128));
	palette.setColor(QPalette::Disabled, QPalette::Base, QColor(255, 255, 255));
	palette.setColor(QPalette::Disabled, QPalette::AlternateBase, QColor(240, 240, 240));
	palette.setColor(QPalette::Disabled, QPalette::Background, QColor(225, 225, 225));
//	palette.setColor(QPalette::Disabled, QPalette::Foreground, QColor(255, 255, 255));
	...
	palette.setColor(QPalette::Disabled, QPalette::Button, QColor(225, 225, 225));
	palette.setColor(QPalette::Disabled, QPalette::ButtonText, QColor(128, 128, 128));
	palette.setColor(QPalette::Disabled, QPalette::BrightText, QColor(255, 255, 255));
	palette.setColor(QPalette::Disabled, QPalette::Highlight, QColor(0, 0, 128));
